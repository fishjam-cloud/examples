			...
			<DialogDescription className="text-lg text-primary flex flex-col gap-4 overflow-auto max-h-[50vh]">
				<section>
					...
					<ul className="list-disc pl-6 mt-2 space-y-1">
						<li>
							...
							- WebRTC SFU that handles all real-time audio streaming between
							players
						</li>
						<li>
							<a
							...
							- Powers the intelligent Storyteller agent with natural voice
							interaction
						</li>
					</ul>
				</section>
				...
				<section>
					...
					<ol className="list-decimal pl-6 space-y-3">
						<li>
							<strong>Room Creation:</strong> When you create a room, a new
							Fishjam room is established. Players connect via WebRTC through
							Fishjam's SFU (Selective Forwarding Unit), enabling efficient
							multi-party audio streaming.
						</li>
						<li>
						...
						<li>
							<strong>Conference Mode Control:</strong> Players can toggle
							between Conference Mode and Question Mode. In Conference Mode, the
							Fishjam Agent stops forwarding player audio to ElevenLabs—players
							can discuss theories privately while still hearing each other
							through Fishjam. When switched to Question Mode, audio
							transmission to the AI resumes, allowing players to ask the
							Storyteller questions.
						</li>
						<li>
							<strong>Smart Audio Routing:</strong> Since multiple players might
							speak at once (which would confuse the AI), the system uses Voice
						...
						<li>
							...
							processes player questions and generates natural spoken responses.
							Audio is streamed back through the Fishjam Agent and broadcast to
							all players in real-time.
						</li>
						<li>
							<strong>Game Completion:</strong> The AI Storyteller monitors the
							game state. When players solve the mystery or time runs out, it
							sends an event to the backend, which gracefully disconnects the
							voice agent and notifies all players.
						</li>
					</ol>
				</section>
			</DialogDescription>
