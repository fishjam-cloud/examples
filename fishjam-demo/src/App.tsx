	...
	return (
		<div class="min-h-screen bg-background p-8">
			...
			<div class="mb-8 flex flex-col items-center gap-2">
				...
				<p class="text-muted-foreground">Broadcast and view live streams over MoQ</p>

				{/* Shared stream name — analogous to "Fishjam ID" in the reference */}
				<div class="mt-4 w-full max-w-xs">
					<div
						class="bg-card text-card-foreground flex flex-col gap-4 rounded-xl border py-6 shadow-sm px-6"
					>
						<div class="space-y-2">
			...
			<div class="mx-auto max-w-7xl grid grid-cols-1 gap-8 lg:grid-cols-2">
				<Streamer streamName={streamName()} />
