...
const LANGUAGE_BY_CODE = new Map(GOOGLE_TRANSLATION_LANGUAGES.map((language) => [language.code, language]));
const LANGUAGE_ORDER = new Map(GOOGLE_TRANSLATION_LANGUAGES.map((language, index) => [language.code, index]));
